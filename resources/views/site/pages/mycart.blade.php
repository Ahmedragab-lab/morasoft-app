        ...
        <div class=" main-content-area">
            @if($cartitems->count() > 0)
                            ...
                            <li class="pr-cart-item product_data">
                                ...
                                <div class="quantity">
                                    <div class="quantity-input">
                                        <input type="number"  min="1" max="9" step="1"  name="prod_qty" value="{{ $item->product_qty }}" data-max="120" pattern="[0-9]*" class="qty-input">
                ...
                <div class="checkout-info">
                        ...
                        <a class="btn btn-warning float end" href="{{ route('checkout.index') }}">Check out</a>
            @else
