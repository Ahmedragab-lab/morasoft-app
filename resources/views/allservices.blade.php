              ...
              <div class="columns is-variable is-4 is-multiline">
               @foreach ( $services as $service )
                    <div class="column is-4" data-aos="fade">
                        <div class="work-item">
                        <figure>
                            {{-- <a href="{{route('front.show',$service->id)}}"> --}}
                            <img alt="Joo - Niche Multi-Purpose HTML Template" src="{{ asset('uploads/service/'. $service->image) }}"> </a>
                            {{-- <figcaption>
                            <ul class="social">
                                <li>
                                ...
                                <li>
                                <a href="../pages/shop-service.html">
                                    <span class="icon">
                                    <i class="icon-link"></i>
                                    </span>
                                </a>
                        ...
                        <div class="work-item-meta">
                            <h3>
                            {{-- <a href="{{route('front.show',$service->id)}}">{{ $service->service_name }}</a> --}}
                            </h3>
                            <h5>
                    ...
                    {{-- @foreach ( $cats as $cat) --}}
                        <div class=" item" >
                            ...
                            <figure class="post-image">
                                {{-- <a href="{{ route('allservices.show',$cat->id) }}"> --}}
